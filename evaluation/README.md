...
`eval_queries_200.csv` là **synthetic regression**: giữ lại để bắt regression,
kiểm tra entity/metadata và sanity check, không dùng làm headline benchmark.
...
generation được theo dõi bằng `Recall@50`. Cần review thủ công các judgment
trước khi dùng số liệu làm claim public.
